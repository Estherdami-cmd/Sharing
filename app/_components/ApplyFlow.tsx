...
export default function ApplyFlow() {
  ...
  async function handleApplySubmit() {
    ...
    // 완료 화면으로 '이동'한다. 여기서 상태만 바꾸면 주소가 그대로여서
    // 새로고침 시 이 폼으로 돌아와 같은 신청을 또 넣을 수 있다.
    // setSubmittingApplication(false)를 부르지 않는 것도 의도적이다 —
    // 페이지가 넘어가는 동안 버튼이 잠겨 있어야 중복 제출을 막는다.
